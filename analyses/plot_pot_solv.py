...
if args.reposition_labels:
    positioner.optimize(dx=1e-3, beta=1e5, krep=1, kspring=1000, c=0.05, b0=0.02, scale=[1, 0.8])
...
if args.reposition_labels:
    positioner.optimize(dx=1e-2, beta=1e4, krep=1, kspring=1000, c=0.2, b0=0.05)
