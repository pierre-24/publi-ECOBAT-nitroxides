...
\begin{figure}[!h]
	...
	\caption{Impact of the dipole orientation of the \ce{R} substituent on the redox potential when the dipole is oriented in  the positive $x$ direction (red, acceptor substituent) or not (blue, donor substituent). Adapted from Ref.~\citenum{zhangEffectHeteroatomFunctionality2018}.}
	\label{fig:dipole}
\end{figure}
